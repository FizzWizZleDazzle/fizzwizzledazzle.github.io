!function(M) {
    ...
    function t(L) {
        ...
        return M[L].call(N.exports, N, N.exports, t),
        N.l = !0,
        N.exports
    }
    t.m = M,
...
, function(M, j, t) {
    ...
    j.b = {
        ...
        explosion: [new L(t(33),20,21), new L(t(34),42,40), new L(t(35),86,72), new L(t(36),130,120), new L(t(37),173,137), new L(t(38),100,95), new L(t(39),94,84), new L(t(40),86,78), new L(t(41),76,69)],
        ground: new L(t(42),192,32),
        groundObjects: [new L(t(43),36,25), new L(t(44),43,28)],
        clouds: [new L(t(45),310,100), new L(t(46),169,81), new L(t(47),459,119), new L(t(48),214,111), new L(t(49),272,165), new L(t(50),385,177), new L(t(51),508,148), new L(t(52),187,99), new L(t(53),213,133)],
        groundhit: [new L(t(54),30,31), new L(t(55),30,31), new L(t(56),30,31), new L(t(57),30,31), new L(t(58),30,31), new L(t(59),30,31), new L(t(60),30,31), new L(t(61),30,31), new L(t(62),30,31), new L(t(63),30,31), new L(t(64),30,31), new L(t(65),30,31)],
        ...
        cow: new L(t(25),66,62,.3),
        cowRunning: [new L(t(72),68,59,.3), new L(t(73),67,62,.3), new L(t(74),68,65,.3), new L(t(75),73,59,.3)],
        cowDead: new L(t(76),70,40,.3),
        ui: {
...
, function(M, j, t) {
    ...
    function I(M, j) {
        ...
        if (t - j.lastSmoke > 80) {
            ...
            u.scale = 1 + .5 * Math.random(),
            u.opacity = L + .2 * Math.random(),
            M.particles.add(u)
        }
    }
    function D(M, j) {
        ...
        for (L = Object(e.i)(L); u > 0; )
            t.position = Object(e.a)(j.previous, Object(e.e)(L, .1), Object(e.e)(j.forward, -10)),
    ...
    function g(M, j, t=!1) {
        ...
        L.velocity = t ? Object(e.s)(0, -2) : Object(e.e)(j.velocity, .5),
        M.particles.add(L)
    }
    function a(M, j) {
        const t = new N.a(i.b.groundhit);
        t.frameDuration = 50,
        t.position = Object(e.s)(j.position.x, M.ground - 15),
        M.particles.add(t)
    }
    function y(M, j) {
        function t(t=-5, L=1) {
            ...
            i.velocity = Object(e.p)(Object(e.s)(0, -5), Math.PI / L / 2 - Math.random() * Math.PI / L),
            i.color = "#d80004",
...
, function(M, j, t) {
    ...
    class u extends L.a {
        ...
        updateParachute() {
            this.parachute && (this.parachute.move(Object(i.a)(this.position, Object(i.s)(this.velocity.x > 0 ? -1 : 1, -22))),
...
, function(M, j, t) {
    ...
    function z(M) {
        ...
        if (2 == M.maxMissiles) {
            ...
            for (let t = 0; t < L.i - M.missiles; t++)
                j[t].classList.add("hidden");
            for (let t = L.i - M.missiles; t < L.i; t++)
                j[t].classList.remove("hidden")
        } else
            c.innerText = "" + M.missiles;
        if (S.style.transform = `translateY(-${j * M.thrust / L.k}px)`,
        M.maxAmmo > L.f)
            n.innerText = "" + M.ammo;
        else {
    ...
    function r(M) {
        ...
        setInterval((function() {
            ...
            for (let j of M.players) {
                let i = j.hasPlane();
                i && (t.fillStyle = j.color,
                t.fillRect(L * i.position.x / M.width - 2, N * i.position.y / M.height - 2, 4, 4))
            }
        }
        ), 300)
    }
...
, function(M, j, t) {
    ...
    function y(M, j) {
        for (let t of M.particles) {
            ...
            t instanceof e && (t.angle += j,
            t.scale += i.m * t.scaleRate * j,
            t.opacity -= i.m * t.opacityRate * j,
            t.opacity < 0 && M.particles.delete(t)),
            t instanceof g && Object(N.g)() - t.timeSinceFrameShown >= t.frameDuration && (t.frame++,
...
, function(M, j, t) {
    ...
    var L, N = t(2), i = t(0), u = t(3), e = t(13);
    !function(M) {
        M[M.Left = 0] = "Left",
        M[M.Right = 1] = "Right"
    }(L || (L = {}));
...
, function(M, j, t) {
    ...
    class e {
        ...
        hasPlane() {
            if (this.object && this.object instanceof N.a)
                return this.object
        }
        hasPilot() {
...
, function(M, j, t) {
    ...
    function y(M, j, t) {
        ...
        return setInterval(()=>{
            ...
            if (t)
                ...
                N()),
                e && (t.thrust -= 2,
                t.thrust < 0 && (t.thrust = 0),
                N()),
                I && (t.thrust += 2,
                t.thrust > L.k && (t.thrust = L.k),
                N()),
                t.elevator = D && !y ? -1 : !D && y ? 1 : 0;
            else {
                const M = j.hasPilot();
                M && (M.landed && (D && !y ? M.velocity.x = -10 : !D && y && (M.velocity.x = 10)),
        ...
        document.addEventListener("keydown", L=>{
            if (t.thrustLevers.up.includes(L.code))
                I = !0;
            else if (t.thrustLevers.down.includes(L.code))
                e = !0;
            else if (t.elevator.up.includes(L.code))
                D = !0;
            else if (t.elevator.down.includes(L.code))
                y = !0;
            else if (L.code === t.fire)
                u = !0;
    ...
    function T(M, j) {
        for (let t of M)
            t instanceof u.a ? A(t, j) : t instanceof I.a && n(t, j)
    }
    function A(M, j) {
        const t = Object(N.h)(M.velocity);
        let i = 1 - t / (L.l * L.d);
        t > L.l && (i = 1 - 1 / L.d),
        M.angle += i * L.e * M.elevator * j,
    ...
    function c(M, j) {
        if (M.has(j)) {
            if (j.ammo > 0) {
                ...
                const t = function(M) {
                    const j = new e.a(M);
                    return j.move(Object(N.a)(M.position, Object(N.e)(M.forward, M.radius + 5))),
                    j.velocity = Object(N.a)(Object(N.c)(M.velocity), Object(N.e)(M.forward, 120)),
                    j
                }(j);
                M.add(t)
            }
    ...
    function o(M, j) {
        if (M.has(j)) {
            if (j.missiles > 0) {
                ...
                const t = function(M) {
                    const j = new I.a(M);
                    return j.move(Object(N.a)(M.position, Object(N.e)(M.normal, -12))),
                    j.angle = M.angle,
                            ...
                            if (void 0 !== j.target)
                                ...
                                for (let I of M)
                                    if (I instanceof u.a) {
                                        if (I === j.source)
                                            continue;
                                        if (void 0 !== (null === (t = I.player) || void 0 === t ? void 0 : t.team) && void 0 !== (null === (L = j.source.player) || void 0 === L ? void 0 : L.team) && I.player.team === j.source.player.team)
                                            continue;
...
, function(M, j, t) {
    ...
    class u extends L.a {
        constructor(M) {
            super(N.b.bullet, Object(i.s)(1, 0), Object(i.s)(0, 1)),
            this.source = M,
            this.radius = 2.5,
            this.circles = [{
                v: Object(i.s)(0, 0),
...
, function(M, j, t) {
    ...
    function I(M, j) {
        ...
        j.setInterval(()=>{
            ...
            t && (j.running = !0,
            j.direction = j.position.x < t.position.x ? e.b.Left : e.b.Right)
        }
        , 1e3),
        j.setInterval(()=>{
        ...
        , 1e3 + 2e3 * Math.random()),
        j.setInterval(()=>{
            t || (j.direction = Math.random() < .5 ? e.b.Left : e.b.Right)
        }
        , 1e3 + 4e3 * Math.random())
    }
    var D = t(1)
    ...
    function a(M) {
        for (let j = 0; j < 120; j++) {
            ...
            let u = M.height;
            for (; u > M.height - 500; )
                u = M.height * Math.random();
            let e = 1e3;
            t.position = Object(i.s)((e + M.width) * Math.random() - e / 2, u),
            M.clouds.push(t)
        }
        for (let j = 0, t = 10; t < M.width; ) {
            const u = new L.d(N.b.groundObjects[j++ % N.b.groundObjects.length]);
            u.position = Object(i.s)(t, M.ground - u.sprite.height + .5),
    ...
    function y(M) {
        function j() {
            let j = new e.a;
            j.move(Object(i.s)(Math.random() * M.width, M.ground - j.sprite.height / 2)),
            I(M, j),
            M.add(j)
        }
        for (let M = D.g; M >= 0; M--)
...
, function(M, j, t) {
    ...
    function T(M, j, t={}) {
        ...
        return S(L.c, ()=>{
            ...
            if (T) {
                if (1 == T.life && M.barns.size > 0) {
                    ...
                    Math.random() < .03 && (L < 1300 ? Object(N.b)(M, j) : j.target = t)
                }
                if (void 0 !== j.target)
                    if (M.has(j.target)) {
                        let t = Object(g.c)(T.position, j.target.position, M);
                        j.target instanceof u.a && (t = Object(a.c)(t),
                        t.y -= 300);
                        const L = Object(a.b)(Object(a.r)(t, T.position), T.forward)
                          , I = Object(a.q)(T.position, t);
                        if (Math.abs(L) > a.l && r(Math.sign(L) > 0 ? 1 : -1),
                        j.target instanceof u.a)
                            return;
                        if (j.target instanceof D.a && L < a.n && I < 500 && Math.random() < i.missileChance && s(),
                        L < a.m && I < 400) {
                            let t = n(M, T, a.o);
                            t instanceof e.a && t.source === T && t.thrust > 0 || c(t, j.team) || Object(N.d)(M, T)
                        }
                    ...
                    if ((null === (L = null === (t = j.team) || void 0 === t ? void 0 : t.leader) || void 0 === L ? void 0 : L.object) && (null === (I = j.team) || void 0 === I ? void 0 : I.leader) !== j) {
                        let t = j.team.leader.object
                          , L = Object(a.a)(t.position, Object(a.a)(Object(a.e)(t.velocity, 10), Object(a.e)(t.normal, 100 * (j.number - j.team.members.length / 2))));
        ...
        S(10 * L.n, ()=>{
            var t, L, N;
            if (j.hasPlane() && (!(null === (L = null === (t = j.team) || void 0 === t ? void 0 : t.leader) || void 0 === L ? void 0 : L.hasPlane()) || (null === (N = j.team) || void 0 === N ? void 0 : N.leader) === j) && void 0 === j.target) {
        ...
        S(5 * L.n, ()=>{
            ...
            if (!j.object)
                return;
            let u = j.object;
            if ((void 0 === (null === (N = null === (t = j.team) || void 0 === t ? void 0 : t.leader) || void 0 === N ? void 0 : N.object) || (null === (i = j.team) || void 0 === i ? void 0 : i.leader) === j) && void 0 === j.target) {
                let j = Object(a.s)(Math.floor(Math.random() * M.width), Math.floor(Math.random() * (M.ground - 100)))
                  , t = S(30, ()=>{
        ...
        S(30, ()=>{
            const t = j.hasPlane();
            t && (Object(a.a)(t.position, Object(a.e)(t.velocity, 4)).y > M.ground && (r(Math.sign(t.forward.x) > 0 ? -1 : 1),
            clearTimeout(l),
            l = o(200, ()=>t.elevator = 0)),
            t.position.y > M.ground - 30 && (r(Math.sign(t.forward.x) > 0 ? -1 : 1),
            clearTimeout(O),
    ...
    function A(M, j, t, L=2e3) {
        ...
        if (void 0 !== j) {
            for (let i of M)
                if (i !== j && !(i instanceof e.a && i.source === j) && !t(i) && (i instanceof D.a || i instanceof I.b || i instanceof e.a && i.target === j && i.thrust > 0)) {
...
, function(M, j, t) {
    ...
    class u {
        ...
        *[Symbol.iterator]() {
        ...
        delete(M) {
            M instanceof L.a ? this.bullets.delete(M) : M instanceof i.b ? this.pilots.delete(M) : this.bodies.delete(M),
            M.destroy()
        }
    }
}
, function(M, j, t) {
    ...
    function a(M, j, t, L, a) {
        ...
        n < 0 ? n = 0 : (M.fillStyle = "#1f4752",
        M.fillRect(0, 0, j.width, n)),
        M.fillStyle = "#9be2fe",
        ...
        function(M, j, t) {
            ...
            if (L < j.height) {
                M.save(),
                M.translate(-j.offsetX % I.b.ground.width, L);
                let t = Math.floor(j.width * j.cameraScale / I.b.ground.width) + 1;
                for (; t-- > 0; )
                    I.b.ground.draw(M),
                    M.translate(I.b.ground.width - 1, 0);
                M.restore()
            }
        }(M, j, t),
        function(M, j, t) {
        ...
        for (let N of t) {
            ...
            if (!(t + N.radius < 0 || t - N.radius > j.width)) {
                if (M.save(),
                D + N.radius < 0)
                    (N instanceof e.a || N instanceof u.a) && (M.translate(Math.floor(t), 3),
                    I.b.pointerUp.drawMiddle(M));
                else if (D - N.radius > j.height)
                    (N instanceof e.a || N instanceof u.a) && (M.translate(Math.floor(t), j.height - 3),
                    I.b.pointerDown.drawMiddle(M));
                else {
                    if (M.translate(t, D),
                    M.rotate(N.angle),
                    ...
                    window.showCircles) {
                        for (let {v: j, r: t} of N.circles)
                            ...
                            M.fill();
                        M.beginPath(),
                        M.arc(0, 0, N.radius, 0, 2 * Math.PI),
                        M.stroke()
                    }
                    ...
                    M.stroke(),
                    M.restore()),
                    N instanceof u.a && N.thrust > 0 && (M.translate(10, 0),
                    I.b.missileFire[Math.random() < .5 ? 0 : 1].drawMiddle(M)),
                    window.showTarget && N instanceof e.a && void 0 !== (null === (A = N.player) || void 0 === A ? void 0 : A.target)) {
                        M.save(),
                        M.rotate(-N.angle);
        ...
        for (let L of t.particles) {
            ...
            M.save(),
            M.translate(t, i),
            L instanceof N.f ? (M.rotate(L.angle),
            M.globalAlpha = L.opacity,
            M.scale(L.scale, L.scale),
            L.sprite.drawMiddle(M)) : L instanceof N.a ? L.sprites[L.frame].drawMiddle(M) : L instanceof N.b ? L.sprite.drawMiddle(M) : L instanceof N.c ? (M.globalAlpha = 1 - Math.min(1, Math.abs((Object(D.g)() - L.createdAt) / L.duration)),
    ...
    function y(M, j, t, L, N, i) {
        ...
        if (u < j.height) {
            M.save(),
            M.globalAlpha = .4,
            M.translate(-j.offsetX / N % L.width, u);
    ...
    function s(M, j) {
        for (let {v: t, r: L} of M.circles)
            if (t = Object(g.a)(Object(g.p)(t, M.angle), M.position),
            t.y + L >= j)
                return !0;
        return !1
    }
        ...
        if (w(M.position, M.radius, j.position, j.radius))
            for (let {v: t, r: L} of M.circles) {
                ...
                for (let {v: M, r: N} of j.circles)
                    if (M = Object(g.a)(Object(g.p)(M, j.angle), j.position),
                    w(t, L, M, N))
                        return !0
            }
        return !1
    ...
    function O(M, j) {
        !function(M) {
            ...
            for (let j of M)
                if (j.position.y + j.radius >= M.ground) {
                    ...
                    if (s(j, M.ground)) {
                        ...
                        j instanceof c.b && (j.landed = !0,
                        Object(g.h)(j.velocity) > 40 ? (Object(A.e)(M, j),
                        Object(A.c)(M, j),
                        M.onCrash(j),
                        M.delete(j),
                        j.player && Object(S.c)(j.player)) : j.parachute && (M.delete(j.parachute),
                        j.parachute = void 0)),
            ...
            for (let j of M.bodies)
                for (let L of M.bodies)
                    j !== L && x(j, L) && (t(j, L) || t(L, j));
            function t(j, t) {
                var L, N, I, D;
                if (j instanceof u.a && t instanceof u.a)
                    return Object(A.d)(M, j),
                    Object(A.d)(M, t),
                    M.delete(j),
                    M.delete(t),
                    !0;
                if (j instanceof e.a && t instanceof u.a)
                    return (!t.justDeployed || t.source !== j) && ((!t.justDeployed || void 0 === (null === (L = t.source.player) || void 0 === L ? void 0 : L.team) || void 0 === (null === (N = j.player) || void 0 === N ? void 0 : N.team) || t.source.player.team !== j.player.team) && (r(M, j),
                    M.delete(t),
                    t.source.player && j.player && Object(S.d)(t.source.player, j.player, S.a),
                    !0));
                if (j instanceof e.a && t instanceof i.a)
                    return (null === (I = j.player) || void 0 === I ? void 0 : I.isHuman) && o.c.cowKilled++,
                    M.onCowKill(t),
                    M.delete(t),
                    !0;
                if (j instanceof u.a && t instanceof i.a)
                    return (null === (D = j.source.player) || void 0 === D ? void 0 : D.isHuman) && o.c.cowKilled++,
                    Object(A.d)(M, t),
                    M.onCowKill(t),
                    M.delete(j),
                    M.delete(t),
            ...
            for (let t of M.bullets) {
                for (let L of M.bodies)
                    x(t, L) && (L instanceof e.a && (L.life -= 1,
                    0 == L.life && (r(M, L),
                    t.source.player && L.player && Object(S.d)(t.source.player, L.player)),
                    M.bullets.delete(t)),
                    L instanceof u.a && (Object(A.d)(M, L),
                    M.delete(t),
                    M.delete(L)),
                    L instanceof i.a && ((null === (j = t.source.player) || void 0 === j ? void 0 : j.isHuman) && o.c.cowKilled++,
                    M.onCowKill(L),
                    M.delete(t),
                    M.delete(L)),
                    L instanceof c.a && (M.delete(L),
            ...
            for (let j of M.barns)
                for (let t of M.pilots)
                    x(j, t) && j.newPlane(M, t);
            for (let j of M.pilots)
                for (let t of M.bodies)
                    x(j, t) && (t instanceof e.a && j.plane !== t && !t.landed && (M.onCrash(j),
                    M.delete(j),
                    Object(A.b)(M, j),
                    Object(A.c)(M, j),
                    t.player && j.player && Object(S.d)(t.player, j.player, S.b)),
                    t instanceof u.a && (Object(A.d)(M, t),
                    M.onCrash(j),
                    M.delete(j),
                    M.delete(t),
                    Object(A.b)(M, j),
        ...
        for (let t of M) {
            ...
            t instanceof u.a && (C(t, M),
            t.thrust > 0 && Object(A.f)(M, t)),
            t instanceof e.a && (E(t, M),
            t.life < l.h && Object(A.g)(M, t)),
            t instanceof c.b && d(t),
            t instanceof c.a && m(t),
            t instanceof n.a && h(t),
            t instanceof i.a && U(t, M);
            const L = Object(g.d)(t.force, t.mass);
            t instanceof e.a && t.landed ? (0 === t.thrust ? t.velocity.x += -t.velocity.x / 2 * j : t.velocity.x += l.m * L.x * j,
            t.angle = Math.PI / 8,
            t.velocity.y = 0,
            ...
            t.previous.y = t.position.y,
            t.position.x += l.m * t.velocity.x * j,
            t.position.y = M.ground - t.sprite.height / 2) : t instanceof c.b && t.landed ? (t.velocity.y = 0,
            t.velocity.x += l.m * L.x * j,
            t.previous.x = t.position.x,
            t.previous.y = t.position.y,
            t.position.x += l.m * t.velocity.x * j,
            t.position.y = M.ground - t.sprite.height / 2) : (t.velocity.x += l.m * L.x * j,
    ...
    function E(M, j) {
        ...
        M.position.y < j.stratosphere && (i = Object(g.g)(),
        u = Object(g.g)(),
        e = Object(g.g)()),
    ...
    function d(M) {
        ...
        M.parachute && (L = Object(g.e)(Object(g.i)(Object(g.f)(M.velocity)), j / 4),
        M.updateParachute()),
...
, function(M, j, t) {
    ...
    var L = t(3);
    const N = ["#f36a20", "#dbaf02", "#70ba01", "#49da9a", "#34bbe6", "#4380db", "#261fe6", "#d23be7", "#ff0786"];
    function i() {
        return Object(L.e)([...N])
    }
}
, function(M, j, t) {
    var L, N, i = {}, u = (L = function() {
        return window && document && document.all && !window.atob
    }
    ,
    function() {
        return void 0 === N && (N = L.apply(this, arguments)),
        N
    }
    ), e = function(M, j) {
        ...
        for (var t = 0; t < M.length; t++) {
            ...
            if (N) {
                ...
                for (; u < L.parts.length; u++)
                    N.parts.push(z(L.parts[u], j))
            } else {
                var e = [];
                for (u = 0; u < L.parts.length; u++)
                    e.push(z(L.parts[u], j));
                i[L.id] = {
                    id: L.id,
                    refs: 1,
                    parts: e
    ...
    function A(M, j) {
        for (var t = [], L = {}, N = 0; N < M.length; N++) {
            var i = M[N]
              , u = j.base ? i[0] + j.base : i[0]
              , e = {
                css: i[1],
                media: i[2],
                sourceMap: i[3]
            };
            L[u] ? L[u].parts.push(e) : t.push(L[u] = {
                id: u,
                parts: [e]
            })
        }
    ...
    function z(M, j) {
        ...
        if (j.transform && M.css) {
            if (!(i = "function" == typeof j.transform ? j.transform(M.css) : j.transform.default(M.css)))
                return function() {}
                ;
            M.css = i
        }
    ...
    M.exports = function(M, j) {
        ...
        j.singleton || "boolean" == typeof j.singleton || (j.singleton = u()),
    ...
    function x(M, j, t, L) {
        var N = t ? "" : L.css;
        if (M.styleSheet)
            M.styleSheet.cssText = s(j, N);
        else {
            var i = document.createTextNode(N)
              , u = M.childNodes;
            u[j] && M.removeChild(u[j]),
            u.length ? M.insertBefore(i, u[j]) : M.appendChild(i)
        }
    }
    function w(M, j) {
        var t = j.css
    ...
    function l(M, j, t) {
        ...
        (j.convertToAbsoluteUrls || i) && (L = y(L)),
        N && (L += "\n/*# sourceMappingURL=data:application/json;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(N)))) + " */");
        var u = new Blob([L],{
            type: "text/css"
        })
          , e = M.href;
        M.href = URL.createObjectURL(u),
...
, function(M, j) {
    M.exports = function(M) {
        ...
        return M.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, (function(M, j) {
            var N, i = j.trim().replace(/^"(.*)"$/, (function(M, j) {
                return j
            }
            ...
            return /^(#|data:|http:\/\/|https:\/\/|file:\/\/\/|\s*$)/i.test(i) ? M : (N = 0 === i.indexOf("//") ? i : 0 === i.indexOf("/") ? t + i : L + i.replace(/^\.\//, ""),
...
, , function(M, j, t) {
    ...
    Object(z.b)((function() {
        ...
        Object(z.a)("#game").addEventListener("submit", M=>{
            ...
            function(M) {
                switch (Object(z.a)("main").style.display = "none",
                ...
                case "teams":
                    !function() {
                        ...
                        j.name = "Red",
                        j.startingPosition = 12e3;
                        const t = new T.b("#145ece");
                        t.name = "Blue",
                        t.startingPosition = 2e3;
                        let N = location.search.match(/count=([0-9]+)vs([0-9]+)/);
                        N && (j.count = parseInt(N[1]),
                        t.count = parseInt(N[2]));
                        ...
                        s.ammo = e.f,
                        s.landed = !0,
                        s.move(Object(o.s)(j.startingPosition - 130, M.ground)),
                        M.add(s),
                        Object(D.a)(M, x, {
                            thrustLevers: {
                                up: ["ArrowUp", "KeyW"],
                        ...
                        M.onCrash = function(j) {
                            ...
                            setTimeout(()=>{
                                ...
                                if (!L)
                                    return;
                                L.points--,
                                L.points <= 0 && setTimeout(()=>{
                                    w || (w = !0,
                                    alert((null == L ? void 0 : L.name) + " team loses\n\n  ¯\\_(ツ)_/¯"),
                                    location.href = "?mode=teams")
                                }
                                , 2 * e.n);
                                const N = new y.a(t.color);
                                N.life = e.h,
                                N.ammo = N.maxAmmo = t.maxAmmo,
                                N.landed = !0,
                                N.move(Object(o.s)(L.startingPosition, M.ground)),
                                t.control(N),
                                M.add(N)
                            }
                            , 6e3))
                        ...
                        for (let t = 1; t < j.count; t++) {
                            ...
                            u.player = I,
                            M.players.push(I),
                            I.maxAmmo = u.maxAmmo = u.ammo = 0 == t ? e.f : e.b,
                            u.landed = !0,
                            u.move(Object(o.s)(j.startingPosition + 50 * t, M.ground)),
                            M.add(u),
                            I.disableAI = Object(L.a)(M, I)
                        }
                        for (let j = 0; j < t.count; j++) {
                            ...
                            u.player = I,
                            M.players.push(I),
                            I.maxAmmo = u.maxAmmo = u.ammo = 0 == j ? e.f : e.b,
                            u.landed = !0,
                            u.move(Object(o.s)(t.startingPosition + 50 * j, M.ground)),
                            u.angle = 2 * Math.PI * Math.random(),
                            M.add(u),
                            I.disableAI = Object(L.a)(M, I)
                        }
                ...
                case "duel":
                    !function() {
                        ...
                        });
                        {
                            ...
                            N.ammo = e.f,
                            N.landed = !0,
                            N.move(Object(o.s)(M.width * Math.random(), M.ground)),
                            M.add(N),
                ...
                case "survival":
                    !function() {
                        ...
                        let z, r = parseInt(t.get("size") || "2"), s = Object(N.a)(), x = new T.b("#ff0015"), w = new y.a(x.color), l = new T.a(Object(n.a)("nickname") || "YOU",x.color,w);
                        l.join(x),
                        l.isHuman = !0,
                        l.control(w),
                        M.players.push(l),
                        w.ammo = w.maxAmmo = l.maxAmmo = 100,
                        w.missiles = w.maxMissiles = l.maxMissiles = 10,
                        w.landed = !0,
                        w.move(Object(o.s)(M.width / 2 - 100, M.ground)),
                        M.add(w),
                        Object(D.a)(M, l, {
                            thrustLevers: {
                                up: ["ArrowUp", "KeyW"],
                        ...
                        let O = ()=>{
                            ...
                            for (let j = 0; j < r; j++) {
                                ...
                                u.control(N),
                                M.players.push(u),
                                N.ammo = N.maxAmmo = u.maxAmmo = e.b,
                                N.move(Object(o.s)(M.width * Math.random(), -100)),
                ...
                case "swarm":
                    !function() {
                        ...
                        for (let t = 1; t < j; t++) {
                            ...
                            N.maxAmmo = e.f,
                            N.ammo = e.f,
                            N.move(Object(o.s)(3 * M.width / 4 + 100 * Math.random(), M.height / 2 + 100 * Math.random())),
                            M.add(N),
                            u.disableAI = Object(L.a)(M, u),
                            w.push(u)
                        }
                        for (let j = 0; j < t; j++) {
                            ...
                            N.maxAmmo = e.f,
                            N.ammo = e.f,
                            N.move(Object(o.s)(1 * M.width / 4 + 100 * Math.random(), M.height / 2 + 100 * Math.random())),
                            N.angle = 2 * Math.PI * Math.random(),
                            M.add(N),
                            u.disableAI = Object(L.a)(M, u)
                        }
